...
* Changed the code to create Amazon EventBridge Rules dynamically
...
[4.0.0]: https://github.com/monteiro-alan/terraform-aws-lambda-scheduler-stop-start/compare/3.1.3...4.0.0
